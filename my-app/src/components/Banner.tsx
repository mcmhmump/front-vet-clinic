    ...
    return(
        ...
        className='relative w-full min-h-screen bg-cover bg-center bg-no-repeat'>
            <div className='max-w-[1440px]'>
                ...
                <div className='relative flex items-start flex-col z-10 mt-8 max-w-[800px] ml-[3%]'>
                    ...
                    <ul className='list-disc list-inside mt-4 text-[18px] text-[#02000F] ml-[4%] space-y-2'>
                    ...
                    <div className='flex items-start px-5 gap-7 mt-4'>
                        {/* <button className='cursor-pointer bg-[#F8721F] text-[#FFFFFF] text-[16px] w-[146px] h-[56px] rounded-[50px] hover:bg-[#f2a982] transition-colors duration-150'>Подробнее</button>
                        <button className='cursor-pointer bg-[#02000F] text-[#FFFFFF] text-[16px] w-[235px] h-[56px] rounded-[50px] hover:bg-[#5f5d5c] transition-colors duration-150'>Зарегестрироваться</button> */}
                        ...
                        <a href="#" className='bg-[#02000F] text-[#FFFFFF] text-[16px] w-[235px] h-[56px] rounded-[50px] text-center p-3.5 hover:bg-[#5f5d5c] transition-colors duration-150'>Зарегестрироваться</a>
                    </div>
                </div>
            </div>
        </section>
